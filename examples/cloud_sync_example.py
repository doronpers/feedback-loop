...
from metrics.sync_client import LocalSyncClient, CloudSyncClient, create_sync_client
...
def example_local_sync():
    ...
    client = LocalSyncClient(
        patterns_file="example_patterns.json",
        metrics_file="example_metrics.json"
    )
