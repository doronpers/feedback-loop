...
Usage:
    ...
    python export_to_db.py --input data/metrics_data.json --format sqlite
"""
        ...
        for gen in generations:
            try:
                ...
                gen_record = MetricsCodeGeneration(
                    ...
                    generation_metadata=gen.get(
                        "metadata", {}
                    ),  # Store input metadata in generation_metadata field
...
def main():
    ...
    parser.add_argument(
        ...
        help="Input metrics JSON file (default: data/metrics_data.json)",
    )
    parser.add_argument(
        "--format",
    ...
    parser.add_argument("--db-uri", help="Database URI (overrides --format)")
    parser.add_argument(
        "--db-path",
        default="metrics.db",
