...
class TestMetricsCollector:
    ...
    def test_log_performance_metric(self):
        ...
        collector.log_performance_metric(
            ...
            details={"size": 1000, "context": "test"}
        )
...
class TestMetricsAnalyzer:
    ...
    def test_init(self):
        ...
        data = {"bugs": [], "test_failures": [], "code_reviews": [], "performance_metrics": [], "deployment_issues": []}
    ...
    def test_get_high_frequency_patterns(self):
        ...
        data = {
            ...
            "test_failures": [
                {"pattern_violated": "pattern1", "count": 3}
            ],
            "code_reviews": [],
            "performance_metrics": [],
            "deployment_issues": []
    ...
    def test_detect_new_patterns(self):
        ...
        data = {
            ...
            "test_failures": [
                {"pattern_violated": "known_pattern", "count": 1}
            ],
            "code_reviews": [],
            "performance_metrics": [],
            "deployment_issues": []
