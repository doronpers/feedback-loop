...
class TestLocalSyncClient:
    ...
    def test_sync_metrics(self, tmp_path):
        ...
        metrics = {"bugs": [{"id": 1, "type": "bug"}], "test_failures": []}
...
class TestCloudSyncClient:
    ...
    def test_not_authenticated(self):
        ...
        client = CloudSyncClient(
            api_url="http://localhost:8000", api_key="", organization_id="org1"
        )
    ...
    def test_sync_patterns_not_authenticated(self):
        ...
        client = CloudSyncClient(api_url="http://localhost:8000", api_key="")
...
class TestSyncClientFactory:
    ...
    def test_create_cloud_client(self):
        ...
        client = create_sync_client(
            use_cloud=True, api_url="http://localhost:8000", api_key="test_key_123"
        )
    ...
    def test_create_client_with_kwargs(self, tmp_path):
        ...
        client = create_sync_client(use_cloud=False, patterns_file=str(patterns_file))
