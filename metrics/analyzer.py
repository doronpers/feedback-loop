    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        report = {
            "summary": {
                ...
                "total_performance_metrics": len(self.metrics_data.get("performance_metrics", [])),
                "total_deployment_issues": len(self.metrics_data.get("deployment_issues", []))
            },
