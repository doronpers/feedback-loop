...
class PatternManager:
    ...
    def _add_changelog_entry(
        self, action: str, pattern_name: str, details: Optional[Dict[str, Any]] = None
    ) -> None:
    ...
    def sync_to_markdown(self, md_path: str = "docs/AI_PATTERNS_GUIDE.md") -> None:
        ...
        try:
            ...
            self._add_changelog_entry(
                "synced_to_markdown",
                "all_patterns",
                {"file": md_path, "pattern_count": len(self.patterns)},
            )
    ...
    def _generate_pattern_sections(self) -> str:
        ...
        sorted_patterns = sorted(
            self.patterns, key=lambda p: p.get("occurrence_frequency", 0), reverse=True
        )
